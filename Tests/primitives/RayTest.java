...
class RayTest {
    ...
    void getClosestPoint() {
        ...
        //EP1
        points.add(new GeoPoint(null,new Point3D(-100,0,45)));
        points.add(new GeoPoint(null,new Point3D(0,200,1)));
        points.add(new GeoPoint(null,new Point3D(-63,0,100)));
        points.add(new GeoPoint(null,new Point3D(0,0,40)));
        points.add(new GeoPoint(null,new Point3D(0,80,8)));
        assertEquals(points.get(3),ray.getClosestGeoPoint(points),"EP1");


        //BVA1
        points=null;
        assertNull(ray.getClosestGeoPoint(points),"BVA1");
        ...
        points.add(new GeoPoint(null,new Point3D(-63,0,100)));
        points.add(new GeoPoint(null,new Point3D(0,80,8)));
        assertEquals(points.get(0),ray.getClosestGeoPoint(points),"BVA2");
        ...
        points.add(new GeoPoint(null,new Point3D(0,80,8)));
        points.add(new GeoPoint(null,new Point3D(0,0,40)));
        assertEquals(points.get(4),ray.getClosestGeoPoint(points),"BVA3");
    }
}